...
- 자료형 > 데이터를 저장하는 규칙 > 테이블 정의할 때 사용 > 컬럼의 자료형
...
2.문자형
    ...
    b. nchar
        - n: national > 오라클 인코딩과 상관없이 해당 컬럼을 UTF-16으로 동작하게
        - variable2(n) : 최대 n자리 문자열, n(문자수)
        - 최소 크기: 1글자
        - 최대 크기: 1000글자
...
2. SQL*PLUS > 오라클 제공. 무료. 오라클이 설치될 때 같이 설치. CLI
3. SQLGate
4. Orange
5. DBeaver
6. ..
